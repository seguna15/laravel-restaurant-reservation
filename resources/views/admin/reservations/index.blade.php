    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-end m-2 p-2">
                ...
                class="px-4 py-2 bg-indigo-500 hover:border-indigo-700 rounded-lg text-white">Create Reservation</a>
            </div>
                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3">Res Date</th>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td class="px-6 py-4">
                                           <div class="flex space-x-2">
                                                <a href="{{ route('admin.reservations.edit', $reservation->id) }}" class="px-2 py-2 bg-green-500 hover:bg-green-700 rounded-lg text-white" >Edit</a>
